...
function Switch({
  ...
  const handleCheckedChange = React.useCallback((checked, event) => {
    ...
    <SwitchPrimitives.Root
      ...
      {leftIcon && (
        <motion.div
          ...
          className="absolute top-[28%] -translate-y-1/2 dark:text-neutral-500 text-neutral-400 [&_svg]:size-3 left-1">
      ...
      {rightIcon && (
        <motion.div
          ...
          transition={{ type: 'spring', bounce: 0 }}
          className="absolute top-[28%] -translate-y-1/2 dark:text-neutral-400 text-neutral-500 [&_svg]:size-3 right-1">
